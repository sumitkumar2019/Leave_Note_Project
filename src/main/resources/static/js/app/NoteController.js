...
//Controller Defined for noteApp
angular
		.module('noteApp')
		.controller(
				'NoteController',
				[
						...
						function(NoteService, $scope) {
								...
								NoteService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while adding Note');
													self.errorMessage = 'Error while adding Note: '
							...
							/**
							 * method to update a note using its id
							 */
								...
								NoteService
										...
										.then(
												...
												function(errResponse) {
													...
													self.errorMessage = 'Error while updating Note '
															+ errResponse.data;
													self.successMessage = '';
												});
							}
							...
							/**
							 * method to remove a note using its id
							 */
							function removeNote(noteId) {
								console.log('About to remove Note with id '
										+ noteId);
								NoteService
										.removeNote(noteId)
										.then(
												...
												function(errResponse) {
													console
															.error('Error while removing Note '
																	+ noteId
																	+ ', Error :'
																	+ errResponse.data);
												});
							...
							/**
							 * method for submitting a form object for saving a note
							 */
							function submit() {
								console.log('Submitting');
								if (self.note.noteId === undefined
										|| self.note.noteId === null) {
									console.log('Saving New Note', self.note);
									addNote(self.note);
								} else {
									updateNote(self.note, self.note.noteId);
									console.log('Note updated with id ',
											self.note.noteId);
								}
							}
